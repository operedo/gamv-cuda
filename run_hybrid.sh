...
#	for size in 2000000 4000000 8000000
#	#for size in 8000000
#	#for size in 500000 
#	#for size in 15625 31250 62500 125000 
#	#for size in 2000000 4000000 8000000
#	#for size in 4000000
#	do
...
#		#for tt in 0.0 0.1 0.15 0.2 0.25 0.3 0.35 0.4 1.0
#		for tt in 0.15 
#		#for tt in 1.0
#		do
#			make clean > /dev/null
#			#make THRES=${tt} > salida_${example}_${size}_hybrid_${tt}.txt 2>&1 
#			make THRES=${tt} > salida_${example}_${size}_cuda.txt 2>&1 
#			#make THRES=${tt} > salida_${example}_${size}_omp-stress_${tt}.txt 2>&1 
...
#				#/usr/bin/time ./gamvCUDAOMP.exe params/gamv-${example}_${size}_cudaomp.par >> salida_${example}_${size}_hybrid_${tt}.txt 2>&1
#				/usr/bin/time ./gamvCUDA.exe params/gamv-${example}_${size}.par >> salida_${example}_${size}_cuda.txt 2>&1
#				#export OMP_NUM_THREADS=1
#				#/usr/bin/time ./gamvCUDAOMP.exe params/gamv-${example}_${size}.par >> salida_${example}_${size}_omp-stress_${tt}.txt 2>&1
