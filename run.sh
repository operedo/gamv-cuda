...
do
	#for size in 15625 31250 62500 125000 250000 500000 1000000 2000000 4000000 8000000  
	for size in 250000 500000 1000000 2000000 4000000 8000000  
	do
		/usr/bin/time /home/hdiuser/dev/gslib-alges/par-gamv/src/gamv_OpenMP params/gamv-${example}_${size}_for.par > salida_openmp_${example}_${size}_12threads_fortran.txt 2>&1 
